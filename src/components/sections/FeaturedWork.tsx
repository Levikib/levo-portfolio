        ...
        {projects.map((p) => (
          <div key={p.num} className="reveal group glass-card rounded-sm overflow-hidden" style={{ position:"relative" }}>
            ...
            <div className="p-7">
              ...
              <div className="flex items-end justify-between gap-4" style={{ paddingTop:"14px", borderTop:"1px solid var(--border)" }}>
                ...
                {p.github && (
                  <a href={p.github} target="_blank" rel="noopener noreferrer"
                    style={{ fontFamily:"var(--font-display)", fontWeight:700, fontSize:"11px", letterSpacing:"0.08em", textTransform:"uppercase", border:`1.5px solid ${p.accent}`, color:p.accent, padding:"8px 16px", textDecoration:"none", transition:"all 0.2s", whiteSpace:"nowrap", flexShrink:0 }}
