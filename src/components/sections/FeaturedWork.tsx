...
const projects: Project[] = [
  ...
  { num:"02", name:"GhostNet", status:"live", statusLabel:"Live in Production", desc:"Full-stack cybersecurity research & training platform. 13 modules, 243 lab steps, a ~5,450 XP economy, 9 standalone security tools, and GHOST Agent, an LLM-powered assistant running inside the platform. Cinematic matrix-rain splash on entry.", tags:["Next.js 14","TypeScript","Supabase","Groq llama-3.3-70b","Realtime"], metrics:[{val:"13",label:"Modules"},{val:"5,450",label:"Total XP"}], github:"https://github.com/Levikib/ghostnet", live:"https://ghostnet-pi.vercel.app", accent:"#10b981", accentRgb:"16,185,129" },
  ...
  { num:"05", name:"Chill Minds Magazine", status:"completed", statusLabel:"Vol. 1A & 1B Published", desc:"A beautifully designed kids mental wellness magazine. Two volumes, 36 pages each. Complete design ownership: concept, layout, illustration direction, typography, production.", tags:["Print Design","Editorial","Typography","Illustration","InDesign"], metrics:[{val:"2",label:"Volumes"},{val:"72",label:"Pages"}], github:null, accent:"var(--forest)", accentRgb:"45,122,69" },
  { num:"06", name:"Hookah Rental & Experience", status:"live", statusLabel:"Live in Production", desc:"Full-stack 3D rental and booking platform for a premium hookah lounge business. A Meshy-generated GLB model at the center of a scroll-driven hero, with a GPU explode shader disassembling it into 7 parts as you scroll.", tags:["Next.js 16","React Three Fiber","Three.js","GSAP","Paystack"], metrics:[{val:"3D",label:"Hero Model"},{val:"25",label:"Flavours"}], github:"https://github.com/Levikib/hookah-website", live:"https://hookah-website-two.vercel.app", accent:"#9d5cf5", accentRgb:"157,92,245" },
];
