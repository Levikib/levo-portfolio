...
export const metadata: Metadata = {
  ...
  description:
    "Design work and resources by Levis Kibirie. Chill Minds Magazine Vol. 1A & 1B: children's mental wellness editorial design. Brand identities, print production, and design systems.",
  keywords: [
