                ...
                <div style={{ padding:isMobile?"24px 20px":"36px 40px" }}>
                  ...
                  <div style={{ display:"flex", gap:"24px", alignItems:"flex-start" }}>
                    ...
                    <div style={{ flex:1, minWidth:0 }}>
                      ...
                      {"readOnlineHref" in product && product.readOnlineHref && (
                        <a href={product.readOnlineHref}
                          style={{ display:"inline-flex", alignItems:"center", gap:"6px", marginTop:"14px", fontFamily:"var(--font-mono)", fontSize:"10px", letterSpacing:"0.08em", textTransform:"uppercase", color:product.accent, textDecoration:"none" }}>
                          Read the magazine online, free →
                        </a>
                      )}
                    </div>
                  </div>
