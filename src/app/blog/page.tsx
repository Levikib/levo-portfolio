...
const POSTS = [
  { id:"01", slug:"building-saas-production", title:"Building a Production SaaS in 6 Months — What Nobody Tells You", excerpt:"Everyone talks about the tech stack. Nobody talks about the 2am deployments, the first time real money moves through your webhook, or what it feels like when a landlord calls because the system is down.", category:"Engineering", accent:"#7c3aed", date:"Feb 2026", readTime:"8 min read", featured:true, tags:["SaaS","Fullstack","Makeja Homes","Founder"] },
